...
```markdown
{{</* music url="/music/Wavelength.mp3" name=Wavelength artist=oldmanyoung cover="Wavelength.jpg" */>}}
```
...
```code
https://www.bilibili.com/video/BV1zt4y197cf
```

一个 `bilibili` 示例:

```markdown
{{</* bilibili BV1zt4y197cf */>}}
或者
...
```code
https://www.bilibili.com/video/BV1zt4y197cf?p=1
```

一个带有 `p` 参数的 `bilibili` 示例:

```markdown
{{</* bilibili BV1zt4y197cf 1 */>}}
或者
{{</* bilibili id=BV1zt4y197cf p=1 */>}}
```
